...
public class TextMenu extends JMenu {
    ...
    private JRadioButtonMenuItem defaultJustifyLeft = new JRadioButtonMenuItem();
    ...
    public TextMenu(DrawPanel owner) {
        ...
        final JMenuItem heightMultiplier = new JMenuItem("Change multiplier");
        heightMultiplier.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
    ...
    public void setDefaults() {
        ...
        JustifyButtonGroup.setSelected(defaultJustifyLeft.getModel(), true);
    ...
    private JMenu makeJustifyMenu() {
        ...
        String[] justifyModes = {"Left", "Right", "Center"};
        ButtonModel model = null;
        ActionListener setJustification = new ActionListener() {
            @Override
        ...
        for (String mode : justifyModes) {
            if (mode.equals("Left")) {
                defaultJustifyLeft = new JRadioButtonMenuItem(mode);
                defaultJustifyLeft.setActionCommand(mode);
                defaultJustifyLeft.addActionListener(setJustification);
                model = defaultJustifyLeft.getModel();
                JustifyButtonGroup.add(defaultJustifyLeft);
                menu.add(defaultJustifyLeft);

            } else {
                JRadioButtonMenuItem m = new JRadioButtonMenuItem(mode);
                m.setActionCommand(mode);
                m.addActionListener(setJustification);
                JustifyButtonGroup.add(m);
                menu.add(m);
            }
        }
        JustifyButtonGroup.setSelected(model, true);
